...
const PLUS_SPLIT = preload("res://addons/script_spliter/assets/plus_row.svg")
const MINUS_SPLIT = preload("res://addons/script_spliter/assets/minus_row.svg")
const SspEditor = preload("res://addons/script_spliter/core/ui/splitter/editor/ssp_editor.gd")
...
func _out_sub_split(__ : Variant = null) -> void:
	...
	if be is CodeEdit:
		...
		for x : Node in Engine.get_main_loop().get_nodes_in_group(&"__SCRIPT_SPLITER__"):
