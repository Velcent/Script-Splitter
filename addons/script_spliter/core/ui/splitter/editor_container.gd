...
#	author:		"Twister"
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
const Dottab = preload("res://addons/script_spliter/core/ui/splitter/taby/dottab.gd")
const CLOSE = preload("res://addons/script_spliter/assets/Close.svg")
...
func _ready() -> void:
	...
	tab.on_start_drag.connect(_on_drag)
	tab.on_stop_drag.connect(_out_drag)
