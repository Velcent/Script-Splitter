...
const SplitterContainer = preload("res://addons/script_spliter/core/ui/splitter/splitter_container.gd")
const NControl = preload("res://addons/script_spliter/core/util/control.gd")

const IoBar = preload("res://addons/script_spliter/core/ui/splitter/io/io_bar.gd")
...
func update_split_container() -> void:
	for x : Node in _current_container.get_tree().get_nodes_in_group(&"__ST_CS__"):
