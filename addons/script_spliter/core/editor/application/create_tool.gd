...
const EditorTool = preload("res://addons/script_spliter/core/editor/tools/editor_tool.gd")

const HelperEditorTool = preload("res://addons/script_spliter/core/editor/tools/helper_editor_tool.gd")
const ScriptEditorTool = preload("res://addons/script_spliter/core/editor/tools/script_editor_tool.gd")
const TextEditorTool = preload("res://addons/script_spliter/core/editor/tools/text_editor_tool.gd")
