...
const CreateTool = preload("res://addons/script_spliter/core/editor/application/create_tool.gd")
const UpdateMetadata = preload("res://addons/script_spliter/core/editor/application/update_metadata.gd")
const FocusTool = preload("res://addons/script_spliter/core/editor/application/focus_tool.gd")
const SelectByIndex = preload("res://addons/script_spliter/core/editor/application/select_by_index.gd")
const FocusByTab = preload("res://addons/script_spliter/core/editor/application/focus_by_tab.gd")
const ReparentTool = preload("res://addons/script_spliter/core/editor/application/reparent_tool.gd")
const MergeTool = preload("res://addons/script_spliter/core/editor/application/merge_tool.gd")
const SplitColumn = preload("res://addons/script_spliter/core/editor/application/split_column.gd")
const SplitRow = preload("res://addons/script_spliter/core/editor/application/split_row.gd")
const RemoveByTab = preload("res://addons/script_spliter/core/editor/application/remove_by_tab.gd")
const RefreshWarnings = preload("res://addons/script_spliter/core/editor/application/refresh_warnings.gd")
const UpdateListSelection = preload("res://addons/script_spliter/core/editor/application/update_list_selection.gd")
const SwapTab = preload("res://addons/script_spliter/core/editor/application/swap_tab.gd")
const RmbMenu = preload("res://addons/script_spliter/core/editor/application/rmb_menu.gd")
const UserTabClose = preload("res://addons/script_spliter/core/editor/application/user_tab_close.gd")
const Io = preload("res://addons/script_spliter/core/editor/application/io.gd")

const ToolDB = preload("res://addons/script_spliter/core/editor/database/tool_db.gd")
const Task = preload("res://addons/script_spliter/core/editor/coroutine/task.gd")
...
var _merge_tool : MergeTool = null
var _update_list_selection : UpdateListSelection = null
var _swap_tab : SwapTab = null
...
func _init(base_container : BaseContainer, base_list : BaseList) -> void:
	...
	_base_container.swap_tab.connect(_on_swap_tab)
...
func _on_swap_tab(from : Container, index : int, to : Container) -> void:
	_swap_tab.execute([from, index, to])
...
func unsplit_column(current : Variant) -> void:
	if _merge_tool.execute([current, false]):
		update_request.emit()
	
func unsplit_row(current : Variant) -> void:
	if _merge_tool.execute([current, true]):
		update_request.emit()
