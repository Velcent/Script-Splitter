...
const Builder = preload("res://addons/script_spliter/core/builder.gd")
const Context = preload("res://addons/script_spliter/core/contex/window.gd")
const SSPContext = preload("res://addons/script_spliter/core/contex/ssp_window.gd")
...
const ICON_ADD_COLUMN : Texture2D = preload("res://addons/script_spliter/assets/split_cplus.svg")
const ICON_ADD_ROW : Texture2D = preload("res://addons/script_spliter/assets/split_rplus.svg")
const ICON_REMOVE_COLUMN : Texture2D = preload("res://addons/script_spliter/assets/split_cminus.svg")
const ICON_REMOVE_ROW : Texture2D = preload("res://addons/script_spliter/assets/split_rminus.svg")
	
const L_TAB_BAR : Texture2D = preload("res://addons/script_spliter/assets/LTabBar.svg")
const R_TAB_BAR : Texture2D = preload("res://addons/script_spliter/assets/RTabBar.svg")
const TAB_BAR: Texture2D = preload("res://addons/script_spliter/assets/TabBar.svg")
